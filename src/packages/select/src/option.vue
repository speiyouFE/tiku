<template>
  <li
    ...
    class="sealui-select-dropdown__item"
    v-show="visible"
    :class="{
...
<script>
  ...
  export default {
    ...
    watch: {
      currentLabel() {
        if (!this.created && !this.parent.remote) this.dispatch('SealSelect', 'setSelected');
      },
      value() {
        if (!this.created && !this.parent.remote) this.dispatch('SealSelect', 'setSelected');
      }
    ...
    methods: {
      ...
      selectOptionClick() {
        if (this.disabled !== true && this.groupDisabled !== true) {
          this.dispatch('SealSelect', 'handleOptionClick', this);
        }
      },
    ...
    beforeDestroy() {
      this.dispatch('SealSelect', 'onOptionDestroy', this);
    }
  };
</script>
