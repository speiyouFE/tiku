  ...
  <div class="sealui-panel is-default">
    ...
    <div class="sealui-panel-body" v-if="lists">
      ...
      <div class="table-body">
        <seal-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange"  v-if="lists.length">
          <ul>
