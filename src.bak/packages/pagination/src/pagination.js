...
import SealSelect from '@/packages/select';
import SealOption from '@/packages/option';
...
export default {
  ...
  render(h) {
    let template = <div class={['sealui-pagination', {
      'is-background': this.background,
      'sealui-pagination--small': this.small
    }] }></div>;
    ...
    const rightWrapper = <div class="sealui-pagination__rightwrapper"></div>;
  ...
  components: {
          ...
          <button
            ...
            on-click={ this.$parent.prev }>
            {
              this.$parent.prevText
                ...
                : <i class="sealui-icon sealui-icon-arrow-left"></i>
            }
          </button>
        );
      }
          ...
          <button
            ...
            on-click={ this.$parent.next }>
            {
              this.$parent.nextText
                ...
                : <i class="sealui-icon sealui-icon-arrow-right"></i>
            }
          </button>
        );
      }
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class="seal-pagination__sizes">
            <seal-select
    ...
    Jumper: {
      ...
      render(h) {
        return (
          <span class="sealui-pagination__jump">
           前往
            <seal-input
              class="sealui-pagination__editor is-in-pagination"
              min={ 1 }
      ...
      render(h) {
        return (
          typeof this.$parent.total === 'number'
            ? <span class="sealui-pagination__total"></span>
            : ''
        );
      }
    },
